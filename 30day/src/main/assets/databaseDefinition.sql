...
CREATE TRIGGER `firstDayCreator`
    ...
    FOR EACH ROW
    BEGIN
        INSERT INTO `challengeAttemptDay` VALUES (1, new.`challenge_id`, new.`_id`, 1, NULL); -- Insert day 1
    END;
...
CREATE TRIGGER `dayCreator`
    ...
    BEGIN
        INSERT INTO `challengeAttemptDay` VALUES (new.`_id`+1, new.`challenge_id`, new.`attempt_id`, 1, NULL); -- Insert next day
    END;
